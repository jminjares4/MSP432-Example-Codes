 ...
 * @brief This program will demostrate how to use external GPIOs to controll a lightshow.
 * @version 0.1
 * @date 2021-12-15
 *
...
void lightShow(lightshow_t myLight)
{
    ...
    {
        for (i = 0; i < 8; i++)
        { // iterate over all the BITs or pins
            switch (myLight)
            { // check the input of myLight
            case LED_CHASER_UP:
